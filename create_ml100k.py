...
parser.add_argument('--dataset_name', type=str, default='ml-100k', help='dataset name', choices=['ml-100k'])
...
raw_data_orig = pd.read_csv(args.rating_file, sep='\t', header=None)
raw_data_orig = raw_data_orig[raw_data_orig[2] > 3.5].reset_index().drop('index', 1)
raw_data_orig = raw_data_orig.drop(3, axis=1)
raw_data_orig = raw_data_orig.drop(2, axis=1)
raw_data_orig = raw_data_orig.rename(columns={0: "userId", 1: "movieId"})
